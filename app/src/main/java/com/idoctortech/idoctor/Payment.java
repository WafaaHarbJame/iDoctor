...
//                Toast.makeText(NewRegistration.this, getResources().getString(R.string.create_account_done), Toast.LENGTH_SHORT).show();
                Intent i = new Intent(Payment.this,AuthChoise.class);
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                if(url.contains(".html")){
                    Toast.makeText(Payment.this, getResources().getString(R.string.create_account_done), Toast.LENGTH_SHORT).show();
