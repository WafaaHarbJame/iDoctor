...
//                Toast.makeText(NewRegistration.this, getResources().getString(R.string.create_account_done), Toast.LENGTH_SHORT).show();
                Intent i = new Intent(NewRegistration.this,AuthChoise.class);
        ...
        mWebView.loadUrl(getResources().getString(R.string.url_registration));
        ...
        mWebView.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if(url.contains(".html")){
                    Toast.makeText(NewRegistration.this, getResources().getString(R.string.create_account_done), Toast.LENGTH_SHORT).show();
                    Intent i = new Intent(NewRegistration.this,Login.class);
                    startActivity(i);
                }
                {
                    view.loadUrl(url);
...
//                Toast.makeText(Test.this, "Could not load your page", Toast.LENGTH_SHORT).show();
                Intent i = new Intent(getApplicationContext(),AuthChoise.class);
                Toast.makeText(getApplicationContext(), getResources().getText(R.string.error_register), Toast.LENGTH_LONG).show();
                startActivity(i);
