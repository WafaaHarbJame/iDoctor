...
public class ViewObject extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    RadioButton radio_meeting,radio_cideo;


    ImageView backBtn;
TextView startFrom,price;
    RequestQueue queue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appostart = (TextView) findViewById(R.id.appostart);
        ...
        radio_cideo = (RadioButton) findViewById(R.id.radio_cideo);
        ...
        if(locale_value.equals("ar")){
            ...
            appostart.setText("يبدأ من");
            book.setText("حجز");
            radio_meeting.setText("مكالمة فيديو");
            radio_cideo.setText("شخصي");
            ...
            appostart.setText("Start From");
            book.setText("Booking");
            radio_meeting.setText("Video Call ");
            radio_cideo.setText("Person");
        }
...
//
        ...
        msg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(), insideMsg.class);
